...
var APIKey = "api.openweathermap.org/data/2.5/weather?q=perth&appid=d6db38001e351111dd620023b7c30d07";
...
$.ajax({
  ...
  method: "GET"
    ...
    function addCurrentWeather() {
        ...
        var tempId = $("<h5>").text("Temperature: " + response.main.temp);
        var windId = $("<h5>").text("Wind speed: " + response.wind.speed);
...
$.ajax({
    ...
    list5thDay.forEach(function(e) {
        ...
        var iconId = $("<i>").addClass(response.list[e].weather.icon);
        var tempId = $("<p>").text("Temp: " + response.list[e].main.temp);
